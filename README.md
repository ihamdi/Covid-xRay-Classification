...
3. [`data`](https://github.com/ihamdi/Covid-xRay-Classification/tree/main/data) directory contains [`train`](https://github.com/ihamdi/Covid-xRay-Classification/tree/main/data/train) folder where the data is expected to be.
